...
export default function ForgotPassword() {
  ...
  const { formErrors, onChange } = useFormValidator(formValues, setFormValues, forgotSchema);

  return (
    <form className={c`flex flex-col`}>
      <Input id="email" label="Email" name="email" errorText={formErrors.email} onChange={onChange} />
