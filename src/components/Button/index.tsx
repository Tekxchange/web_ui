...
const buttonColorMap: Record<ButtonColor, string> = {
  ...
  [ButtonColor.Red]: "bg-red-400 hover:bg-red-300 text-black hover:shadow-black",
  [ButtonColor.Green]: "bg-green-400 hover:bg-green-300 text-black hover:shadow-black",
  [ButtonColor.Blue]: "bg-blue-300 hover:bg-blue-200 text-black hover:shadow-black",
  [ButtonColor.Gold]: "bg-yellow-400 hover:bg-yellow-300 text-black hover:shadow-black",
};
